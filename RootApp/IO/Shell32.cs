...
namespace RootApp.IO
{
    ...
    public static class Shell32
    {
        ...
        //public const uint FILE_ATTRIBUTE_FILE = 0x00;
        ...
        private static int GetIconIndex(string pszFile, uint dwFileAttributes)
        {
            ...
            Shell32.SHGetFileInfo(
                ...
                (uint)(SHGFI.SysIconIndex | SHGFI.SmallIcon | SHGFI.UseFileAttributes));
            return sfi.iIcon;
        }

        private static IntPtr GetIconPtr(int iImage, IconSize iconSize)
        {
            IImageList spiml = null;
            Guid guid = new Guid(IID_IImageList);

            Shell32.SHGetImageList((int)iconSize, ref guid, ref spiml);
        ...
        public static Size GetIconSize(IconSize iconSize)
        {
            ...
            switch (iconSize)
            {
                ...
                case IconSize.ExtraLarge:
                    length = 48;
                    break;
                // TODO: Implement via GetSystemMetrics, SM_CXICON etc
        ...
        public static ImageSource GetIcon(string path, IconSize iconSize, bool isDirectory = true)
        {
            Size size = GetIconSize(iconSize);
            ImageSource imageSource;

            IntPtr hIcon = GetIconPtr(
                GetIconIndex(
                    path,
                    isDirectory == true ? FILE_ATTRIBUTE_DIRECTORY : FILE_ATTRIBUTE_NORMAL),
                iconSize);
